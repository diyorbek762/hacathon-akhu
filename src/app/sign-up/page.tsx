    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] px-6">
      <div className="w-full max-w-md">
        <Link href="/" className="flex items-center justify-center gap-2.5 mb-10 no-underline">
          <img src="/logo.png" alt="PEER MATCH" className="w-10 h-10 rounded-lg object-cover" />
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-8">
          <h1 className="font-syne font-bold text-2xl mb-2">Create your account</h1>
          <p className="text-[var(--text-dim)] text-sm mb-8">Join thousands of students already matched.</p>
          ...
          <p className="text-center text-sm text-[var(--text-dim)] mt-6">
            ...
            <Link href="/sign-in" className="text-[var(--teal)] no-underline hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
